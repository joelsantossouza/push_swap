...
#    Updated: 2025/12/03 19:36:48 by joesanto         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INSTRUCTIONS = $(addprefix $(INSTRUCTIONS_DIR)/, rotate.c push_to.c)
...
OBJS = $(MAIN:.c=.o) $(PARSING:.c=.o) $(SORTING:.c=.o) $(INSTRUCTIONS:.c=.o)
LIBS_DIR = libs
